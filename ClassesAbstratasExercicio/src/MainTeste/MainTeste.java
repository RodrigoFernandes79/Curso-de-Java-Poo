...
public class MainTeste {
	...
	public static void main(String[] args) {
		...
		for (int i = 1; i <= quantidade; i++) {
			...
			System.out.println("Pessoa Física ou Pessoa Juridica?[f/j]");
			tc.nextLine();
			...
			if (tipo == 'f') {
				...
				System.out.println("Número de fúncionarios: ");
		...
		for (Contribuinte x : list) {
			...
			System.out.println("O Contribuinte " + x.getNome() + " pagará R$ " + String.format("%.2f", x.calcImpostoTotal()));
